...
int main(int argc, char **argv)
{
    ...
    double max_speed;
    string cmd_topic;
    string func_motors_topic; 
    ros::param::param<double>("~max_speed", max_speed, 1.0);
    ros::param::param<std::string>("~cmd_topic", cmd_topic, "cmd_vel");

    ros::param::param<std::string>("~func_motors_topic", func_motors_topic, "func_motors"); //获取功能电机话题
